...
class QAOArunner():
    ...
    """
    def __init__(self, graph, backend_mode = 'statevector', param_initialization="uniform",optimizer="COBYLA", qaoa_variant ='vanilla', maxiter = 5000, 
                 warm_start=False,depth = 1, problem_type = 'maxcut',max_tol = 1e-4, amount_shots = 5000, lagrangian_multiplier = 2, hamming_dist = 0, epsilon = 0.3):
