...
body = 'Solstorm run -papergraph - results_papergraph_depth_{2, 4, 6}.csv'
attachment = 'results/results_papergraph_depth_{2, 4, 6}.csv'
...
recipient = "torbjorn.smed@gmail.com"
subject = "Data from Python Script"
body = 'Solstorm run -papergraph - results_papergraph_depth_{8, 10}.csv'
attachment = 'results/results_papergraph_depth_{8, 10}.csv'
